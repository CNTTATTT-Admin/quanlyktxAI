                ...
                <div className="col-md-8">
                  <div className="mb-4">
                    ...
                    <p className="mb-4">
                      ...
                      <a href="/signup-rentaler">Đăng ký tài khoản mới</a>
                    </p>
                  </div>
                  <LoginForm />
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="d-flex mb-5 align-items-center">
        <span className="ml-auto">
          <a href="/forgot-password" file="forgot-pass" className="forgot-pass">
            Quên mật khẩu
          </a>
        </span>
      </div>
...
function SocialLogin() {
  const handleLogin = () => {
    localStorage.setItem("social_login_redirect", "/rentaler");
  };
