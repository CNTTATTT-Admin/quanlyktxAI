      ...
      <div className="container-fluid p-4 eco-bg">
        ...
        <div className="row mb-4 align-items-center">
          <div className="col-12">
            <h2 className="fw-bolder text-dark mb-1">Quản lý đơn xin nghỉ</h2>
            <p className="text-muted mb-0">Theo dõi, xét duyệt hoặc từ chối các đơn xin nghỉ của khách thuê trọ.</p>
          </div>
        </div>
                ...
                <tr>
                  <td colSpan="6" className="text-center py-5">
                    <div className="text-muted">
                      <i className="bi bi-calendar-x fs-1 d-block mb-3 opacity-50" style={{fontSize: "2.5rem"}}></i>
                      <span style={{fontSize: "1rem"}}>Không có đơn xin nghỉ nào cần xử lý.</span>
                    </div>
                  </td>
                </tr>
              ) : (
