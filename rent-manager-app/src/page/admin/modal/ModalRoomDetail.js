...
const ModalRoomDetails = ({ roomId }) => {
  ...
  return (
    <>
      <style>{`
        .text-emerald { color: #1d4ed8 !important; }
        .bg-emerald { background-color: #1d4ed8 !important; color: white !important; }
        
        .modern-card { transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); }
        .modern-card:hover { transform: translateY(-4px); box-shadow: 0 15px 35px rgba(29, 78, 216, 0.1) !important; }
        
        .amenity-card { transition: all 0.3s ease; cursor: default; }
        .amenity-card:hover { background-color: #D1FAE5 !important; border-color: #1d4ed8 !important; transform: translateY(-3px); box-shadow: 0 4px 10px rgba(29, 78, 216, 0.1); }
        
        .resident-card { transition: all 0.3s ease; border: 1px solid #f1f5f9; }
        .resident-card:hover { transform: translateY(-3px); box-shadow: 0 6px 15px rgba(29, 78, 216, 0.15) !important; border-color: #1d4ed8 !important; }
        ...
        .input-modern:focus { box-shadow: 0 0 0 3px rgba(29, 78, 216, 0.2) !important; border-color: #1d4ed8 !important; transform: translateY(-1px); }
        .btn-modern { transition: all 0.3s ease; }
        .btn-modern:hover { transform: translateY(-2px); box-shadow: 0 6px 15px rgba(29, 78, 216, 0.3) !important; }
      `}</style>
