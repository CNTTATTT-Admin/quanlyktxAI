                    ...
                    <div className="card-body py-3">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          <div
                            className="rounded-circle bg-primary text-white p-2 me-3"
                            style={{
                              width: "40px",
                              height: "40px",
                              display: "flex",
                          ...
                          <div>
                            <h5 className="mb-0 fw-bold text-dark">
                              Cấu hình Face ID Liveness
                            </h5>
                            <small className="text-muted">
                              Chế độ chớp mắt bảo mật (Active Liveness)
                            </small>
                          </div>
                        </div>
                        <div className="d-flex align-items-center">
                          <span
                            className={`me-3 mr-4 badge rounded-pill ${enableLiveness ? "bg-success" : "bg-danger"}`}
