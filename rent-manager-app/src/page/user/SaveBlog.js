                            ...
                            <div className="price-box d-flex">
                              <span className="price-a">
                                {item?.room.status === "ROOM_RENT" &&
                                  `Cho thuê |  ${item?.room.price.toLocaleString(
                                    "vi-VN",
                                    {
                                      style: "currency",
                                      currency: "VND",
                                ...
                                {item?.room.status === "HIRED" &&
                                  `Đã thuê | ${item?.room.price.toLocaleString(
                                    "vi-VN",
                                    {
                                      style: "currency",
                                      currency: "VND",
                                ...
                                {item?.room.status === "CHECKED_OUT" &&
                                  `Đã trả phòng | ${item?.room.price.toLocaleString(
                                    "vi-VN",
                                    {
                                      style: "currency",
                                      currency: "VND",
