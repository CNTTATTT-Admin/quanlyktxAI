            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="card-box-c foo">
                  ...
                  <div className="card-body-c">
                    <p className="content-c">
                      Quy trình quản lý chi phí minh bạch, hỗ trợ theo dõi các
                      khoản phí phòng, điện nước và dịch vụ một cách rõ ràng. Hệ
                      thống giúp tối ưu chi phí vận hành, hạn chế sai sót và
                      mang lại lợi ích tối đa cho cả ban quản lý và người ở.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="card-box-c foo">
                  ...
                  <div className="card-body-c">
                    <p className="content-c">
                      Tự động hóa các quy trình như đăng ký phòng, cập nhật
                      thông tin cư trú, xử lý yêu cầu và báo cáo quản lý. Nhờ
                      đó, mọi thao tác được thực hiện nhanh chóng, tiết kiệm
                      thời gian và nâng cao hiệu quả vận hành ký túc xá.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            ...
            <div className="row">
              {rentaler.map((rentaler) => (
                <div className="col-md-4 mb-4" key={rentaler.id}>
                    ...
                    <div className="testimonials-box">
                      <div className="row">
                        ...
                        <div className="col-sm-12 col-md-6">
                          ...
                          <div className="testimonials-content">
                            <p className="testimonial-text">
                              Không có lời nào diễn tả được cảm xúc của tôi lúc
                              này
                            </p>
                          </div>
                          <div className="testimonial-author-box">
                    ...
                    <div className="testimonials-box">
                      <div className="row">
                        ...
                        <div className="col-sm-12 col-md-6">
                          ...
                          <div className="testimonials-content">
                            <p className="testimonial-text">
                              Hạnh phục của tôi là kiếm được một căn trọ sạch sẽ
                              và đẹp đẽ mà lại còn gần trường.
                            </p>
                          </div>
                          <div className="testimonial-author-box">
                            <img
